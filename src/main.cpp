...
uint256 hashGenesisBlock("0x5e98730c779a1201121f9d6c7a542d746c49a8b44d97b0f0ec45b6b5a1b5b860");
...
const string strMessageMagic = "MadibaCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3600; // MadibaCoin: 1 days
static const int64 nTargetSpacing = 600; // MadibaCoin: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal madibacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MadibaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5e98730c779a1201121f9d6c7a542d746c49a8b44d97b0f0ec45b6b5a1b5b860");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Twenty years after mandelas release";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401284613; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3531274;

        if (fTestNet)
        {
            block.nTime    = 1401284613;
            block.nNonce   = 3531274;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe2a3c4325dda05d55a2302b7975ea3d930adf90c301e1030284fb7be7be4a8bd"));
